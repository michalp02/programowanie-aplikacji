...
class PersonEditCtrl {
    ...
    public function validateSave() {
        ...
        $this->form->phone = $v->validateFromPost('phone', [
            'trim' => true,
            'required' => true,
            'required_message' => 'Podaj numer telefonu',
            'numeric' => true,
            'min_length' => 9,
            'max_length' => 15,
            'validator_message' => 'Numer telefonu musi mieć od 2 do 15 znaków i składać się wyłącznie z cyfr'
        ]);
